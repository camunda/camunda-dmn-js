...
import HideDecisionVariableGroupProviderModule from './features/hide-decision-variable-group';

// disables variable creation, cf. https://github.com/camunda/camunda-modeler/issues/6136
const NULL_CREATE_SHAPE_BEHAVIOR = {
  'createShapeBehavior': [ 'value', null ]
};
  ...
  constructor(options = {}) {
    ...
    super({
      ...
      drd: mergeModules(drd, [
        ...
        NULL_CREATE_SHAPE_BEHAVIOR,
        DmnPropertiesPanelModule,
        DmnPropertiesProviderModule,
        HideDecisionVariableGroupProviderModule
      ]),
